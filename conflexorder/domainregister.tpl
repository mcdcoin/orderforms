		...
		<section id="page" class="backgroundf7f7f7">
			<div class="container">
				<ul id="domainIslemi" class="nav-justified">
					<li role="presentation" class="active"><a href="#alanAdiSorgula" aria-controls="alanAdiSorgula" role="tab" data-toggle="tab">Alan Adı Sorgula</a></li>
					<li role="presentation"><a href="#alanAdiTransferi" aria-controls="alanAdiTransferi" role="tab" data-toggle="tab">Alan Adı Transferi</a></li>
				</ul>

				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active" id="alanAdiSorgula">
						<div id="domainIslemIcerik">
							<form method="post" action="cart.php" id="frmDomainChecker">
								<div class="input">
									...
									if ($_POST) {
									{/php}
									<input type="text" name="domain" id="inputDomain" value="{php}echo $_POST["domain"].$_POST["uzanti"];{/php}" class="standartWidth" />
									{php}
									}else{
									{/php}
					...
					<div role="tabpanel" class="tab-pane fade" id="alanAdiTransferi">
		        <div id="domainIslemIcerik">
